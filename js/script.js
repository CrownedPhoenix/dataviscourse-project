loadData("dataviscourse-project/data/termsParty.csv").then((data) => {
  console.log(data);
...
loadData("dataviscourse-project/data/termsEngagement.csv").then((data) => {
  console.log(data);
...
loadData("dataviscourse-project/data/Bioguide IDs.csv").then((bID) => {
  loadData("dataviscourse-project/data/socialStats.csv").then((data) => {
